...
def cria_periodo_com_descricao_materias(descricao_materias_array, periodo)
  descricao_materias = CourseDescription.create(descricao_materias_array)
  courses = []

fila = 0
  descricao_materias.each do |descricao_materia|
    materia = Course.create({course_description:descricao_materia, row:fila, column: periodo})
...
grade_nova = Syllabus.create({name: "Grade Nova"})
bcc.syllabuses << grade_nova
...
grade_nova.courses << descricao_materias_periodo1
grade_nova.courses << descricao_materias_periodo2
grade_nova.courses << descricao_materias_periodo3
grade_nova.courses << descricao_materias_periodo4
grade_nova.courses << descricao_materias_periodo5
grade_nova.courses << descricao_materias_periodo6
grade_nova.courses << descricao_materias_periodo7
grade_nova.courses << descricao_materias_periodo8
